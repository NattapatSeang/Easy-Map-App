...
public class MapShow extends AppCompatActivity {
    ...
    // Request string for map
    String reqMap;
    // Request string for map object
    String reqObject;
    // Request string for map item
    String reqItem;

    // Array of all map with the same name (different floor)
    private ArrayList<Map> maps;
    // Array of object inside the map
    private ArrayList<MapObject>[] objects;
    // Array of the map item
