...
public class CustomView extends View {
    ...
    private ArrayList<MapObject> mapObjectsAll;
    private ArrayList<MapObject>[] mapObjects;
    private ArrayList<MapItem> mapItemsAll;
    ...
    private void init(@Nullable AttributeSet set){
        ...
        maps = new ArrayList<>();
        mapObjectsAll = new ArrayList<>();
        mapItemsAll = new ArrayList<>();
    }
    ...
    public void highlight(int index) { paints[index].get(index).setColor(Color.YELLOW); }

    public void deHighlight(int index)
    {
        paints[index].get(index).setColor(Color.GRAY);
    }
